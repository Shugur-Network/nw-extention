...
### v0.9.6 (Current) — October 12, 2025

**Fixes:**

- Fixed content script import error (removed `prefetch.js` from manifest)
- Fixed cache clearing to preserve user settings (`nweb_default_site`, `nweb_log_level`)

**Changes:**

- Disabled hover-to-prefetch feature (ES module incompatibility)
- Cache clearing now preserves default website and log level
- Updated confirmation dialog to clarify what's preserved

### v0.9.5 — October 8, 2025

**Protocol Changes:**

- Removed `site_index` from DNS TXT record
- Extension now queries relays by pubkey for latest site index
- One-time DNS setup (never update DNS again for site updates)

**Improvements:**

- Site index always fetched fresh (TTL=0)
- Fixed cache staleness with multiple sites on same pubkey
- Improved DNS detection logic

### v0.9.4 — October 6, 2025

**Major Changes:**

- Sandboxed iframe rendering pattern (Chrome MV3 official approach)
- Full JavaScript execution support (inline scripts work!)
...
- **Architecture** inspired by [MetaMask Extension](https://github.com/MetaMask/metamask-extension)
- **Nostr Protocol** by [fiatjaf](https://github.com/fiatjaf) and contributors
- **Shugur Infrastructure** — Relay and Blossom hosting

## 🔗 Links

- **Publisher CLI** — [../publisher](../publisher)
- **Documentation** — [../docs](../docs)
- **NIP-YY** — [../docs/NIP-YY.md](../docs/NIP-YY.md)
- **NIP-ZZ** — [../docs/NIP-ZZ.md](../docs/NIP-ZZ.md)
- **GitHub** — [https://github.com/Shugur-Network/nostr-web](https://github.com/Shugur-Network/nostr-web)
